...
# -*- coding: utf-8 -*-
"""====================================
# @Time    : 2019/7/29 13:41
# @Author  : Jing
# @FileName: customized_estimator.py
# @IDE: PyCharm
======================================="""
import numpy as np
...
def model_fn(features, labels, mode, params):
    ...
    eval_metric_ops = {"my_metric": tf.metrics.accuracy(
        tf.argmax(predict, 1), labels=labels)}
...
train_input_fn = tf.estimator.inputs.numpy_inputs_fn(
...
test_input_fn = tf.estimator.inputs.numpy_inputs_fn(
...
predict_input_fn = tf.estimator.inputs.numpy_inputs_fn(
    x={"image": mnist.test.images[:10]},
